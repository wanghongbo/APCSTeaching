...
public class WebServer {
    ...
    private static final Map<Integer, ConnectN> BOARD_MAP = new HashMap<>();
    ...
    private static void handleAction(final RoutingContext routingContext) {
        ...
        if (actionContent.containsKey("board")) {
            board = BOARD_MAP.get(actionContent.getInteger("board"));
        }
